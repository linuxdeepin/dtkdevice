...
deep@deep-PC:~$ cat /proc/stat
cpu  6458506 128 2319291 300082853 3717580 0 27458 0 0 0
cpu0 355635 2 134492 18865185 171741 0 145 0 0 0
cpu1 368652 1 132593 18865942 164105 0 42 0 0 0
cpu2 386927 2 134498 18867321 148331 0 27 0 0 0
...
int n = 0)
{
  ...
  /*
   * device-tree.cpp creates all CPU nodes on Power Systems.
...
bool scan_cpuinfo(hwNode & n)
{
  ...
  int cpuinfo = open(PROC_CPU_INFO_PATH, O_RDONLY);
